  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-orange-400 to-pink-500">
          ...
          <div className="bg-gray-100 rounded-lg p-4 h-40 mb-4 overflow-y-auto">
            <div className="text-sm text-gray-600">
              ...
              <p className="text-xs text-gray-400 italic">
                (Esta es una funcionalidad simulada. Para el envío de correos real,
                se requiere una configuración de backend.)
              </p>
            </div>
          </div>
      ...
      >
        ...
        <p className="text-white/80 text-lg">¿Qué aventura culinaria vivirás hoy?</p>
      </motion.div>
                  ...
                  <div className="flex-1">
                    ...
                    {item.disabled && (
                      <div className="flex items-center gap-1 mt-2">
                        ...
                        <span className="text-xs text-gray-400">Requiere conexión</span>
                      </div>
                    )}
                  </div>
                </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="text-center pb-6 mt-4">
