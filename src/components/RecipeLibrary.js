...
import { ArrowLeft, Search, Download, Heart, ChefHat, Star, Edit, Plus, Filter, X } from 'lucide-react'; // Added X for clear filter
import { useNavigate } from 'react-router-dom';
import { getFirestore, collection, getDocs, query, orderBy, limit, doc, updateDoc, addDoc, serverTimestamp, where } from 'firebase/firestore';
...
const RecipeLibrary = () => {
  ...
  const handleToggleFavorite = async (recipeId, isCurrentlyFavorite) => {
    ...
    try {
      ...
      alert(isCurrentlyFavorite ? "Receta eliminada de favoritos." : "Receta añadida a favoritos!");
    } catch (error) {
